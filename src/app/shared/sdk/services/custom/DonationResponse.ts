...
export class DonationResponseApi extends BaseLoopBackApi {
  ...
  /**
   * Fetches belongsTo relation donationRequest.
   *
   ...
   * </em>
   */
  public getDonationRequest(id: any, refresh: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/DonationResponses/:id/donationRequest";

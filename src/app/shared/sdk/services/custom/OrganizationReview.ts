...
export class OrganizationReviewApi extends BaseLoopBackApi {
  ...
  /**
   * Fetches belongsTo relation reviewedRequest.
   *
   ...
   * </em>
   */
  public getReviewedRequest(id: any, refresh: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/OrganizationReviews/:id/reviewedRequest";

...
export class DonnerReviewApi extends BaseLoopBackApi {
  ...
  /**
   * Fetches belongsTo relation reviewedResponse.
   *
   ...
   * </em>
   */
  public getReviewedResponse(id: any, refresh: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/DonnerReviews/:id/reviewedResponse";
